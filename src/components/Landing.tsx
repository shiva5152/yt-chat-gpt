  ...
  return (
    <div className="flex h-full max-md:justify-between px-2 w-full flex-col items-center justify-center">
      <div className="flex h-full px-2 w-full flex-col items-center justify-center">
        ...
        <p className="max-md:w-full  text-center dark:text-[#a8a8a8] text-[#6e7191] w-[65%] mt-10">
      ...
      <div className="max-md:w-full max-md:mb-2 align-bottom mt-16  rounded-[20px] dark:bg-[#323232] dark:text-white bg-white shadow-md  w-[50%] mx-auto p-1 mb-5">
        <LandingInput />
      </div>
    </div>
  );
