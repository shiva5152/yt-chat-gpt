...
const DemoCredentionls = () => {
  const handleCopyEmail = () => {
    navigator.clipboard.writeText("ms4544311@gmail.com");
    notifySuccess("Email copied to clipboard");
  };

  const handleCopyPassword = () => {
    navigator.clipboard.writeText("123shiva@demo");
...
export default DemoCredentionls;
